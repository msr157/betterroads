/**
 * Minimal inline brand icons for the footer / waitlist header.
 * Keyed by the SOCIALS `label` in constants.ts. `currentColor` so they inherit
 * whatever text colour the parent sets.
 */
