...
export default function DeleteAccount() {
  return <LegalLayout title="Delete your BetterRoads account" intro="You can permanently remove your BetterRoads profile and account links from the Android app or request help from our privacy team.">
    <Section n={1} title="Delete in the app"><ol><li>Open BetterRoads and enter your account.</li><li>Tap <strong>Profile</strong>.</li><li>Tap <strong>Delete account</strong> and confirm.</li></ol></Section>
    <Section n={2} title="If you cannot access the app"><p>Email <a href={`mailto:${LEGAL.privacyEmail}?subject=BetterRoads%20account%20deletion`}>{LEGAL.privacyEmail}</a> with the contributor ID shown in your profile, or from the linked Google email if you added one. We may verify ownership before completing the request.</p></Section>
