...
const args = ['run', '--rm', '-v', `${app}:/proj`, '-v', `${signing}:/signing:ro`, '-v', 'betterroads-gradle-cache:/root/.gradle', '-w', '/proj', image, 'bash', '/proj/build-release.sh'];
console.log(`Building BetterRoads Android release with ${image}`);
